...
Switch operatorius 
Jis panašiai naudojamas kaip ir "if" ir "Ternary" operatorius.
Tik skiriasi užrašymas ir tiesiog skaitomumas.

Switch : case "blue" =>       if : akys==="blue"
          break;                    else if
...
// Šioje vietoje switch naudojamas, kaip procesas, parodo kiek liko atlikti procesų
// Arba liko nuvažiuoti stotelių iki maršruto pabaigos
// Tam "Break" operatorius yra panaudojamas tik paskutiniame "Case", todėl ir yra parodomas visas likę sąrašas
